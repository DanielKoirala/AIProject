...
def is_valid(solution):
    for i in range(9):
        ...
        subgrid_counts = Counter(solution[x][y] for x in range(start_row, start_row+3) for y in range(start_col, start_col+3))
...
final_solution = hill_climbing(best_solution)
